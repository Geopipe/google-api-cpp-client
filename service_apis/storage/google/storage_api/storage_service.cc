...
StorageService::StorageService(client::HttpTransport* transport)
  : ClientService("https://www.googleapis.com/", "storage/v1/", transport), bucket_access_controls_(this), buckets_(this), channels_(this), default_object_access_controls_(this), object_access_controls_(this), objects_(this) {
}
